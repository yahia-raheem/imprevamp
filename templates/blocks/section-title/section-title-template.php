...
$prefix = mb_get_block_field('section_title_prefix');
$lightMode = mb_get_block_field('light_mode');
?>
<section id="<?= $id ?>" class="<?= $class ?> <?php if ($hasPaddingTop) : ?> has-padding-top <?php endif;
                                                                                            if ($hasPaddingBottom) : ?> has-padding-bottom <?php endif; ?> <?php if ($lightMode) : ?> light <?php endif; ?>">
    <div class="container">
        <div class="row">
            <div class="col-12">
